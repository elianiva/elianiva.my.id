import require$$0$2, { resolve, join, normalize, dirname } from 'path';
...
import require$$0$3 from 'querystring';
import { fileURLToPath, parse as parse$7, URLSearchParams } from 'url';
...
const { parse: parse$1 } = require$$0$3;
