...
>
	<div class="h-full flex md:(fixed h-screen flex-col w-20) items-center justify-center max-w-screen-lg mx-auto px-4">
		<ul class="list-none flex md:flex-col gap-10 items-center justify-center">
			...
			{/each}
			<hr class="hidden md:block border-gray-300 dark:border-gray-800 h-1 w-full" />
			<li>
				<Moon />
			</li>
		</ul>
