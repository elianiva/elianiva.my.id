<footer
  class="relative mt-12 text-center py-10 px-1 bg-white dark:bg-gray-900 border-t border-gray-300 dark:border-gray-800 transition-[filter] ease-out duration-200 font-heading"
>
