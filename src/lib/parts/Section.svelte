<section class="relative mt-16 font-sans text-slate-800 dark:text-slate-200 text-center z-[2]">
	<Pattern className="text-blue-600 dark:text-red-500 absolute top-0 -left-8 w-56 h-40" />
	<h1
