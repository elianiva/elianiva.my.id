---
title: Configuring nushell nix environment on MacOS
date: 2025-05-01
type:  til
links:
  - url: https://discourse.nixos.org/t/any-nix-darwin-nushell-users/37778/4
---

When using Nu as the default Ghostty command, it will ignore the environment set by Nix (because usually shells are sourcing /etc/bashrc or something like that)

This should mitigate that issue.
