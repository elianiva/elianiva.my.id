...
From now on, I will write a bunch of posts about different things and not all of them will be technical! I'm still learning Japanese but I really want to try to write a full post in Japanese some day.
...
After I graduate and get my bachelor's degree, I'm planning to pursue a master's degree because I didn't feel like I learned anything for the past few years I was in college.

### Getting rid of anime subtitles

I wrote [this post after learning it for a year](/posts/a-year-of-japanese), that was before I went to college. I didn't get far since then unfortunately, mainly because I stopped learning Japanese after I got accepted. It's a bit hard to split the time between college, work, and studying Japanese.

I mean, at one point I'm taking 4 different freelance jobs, and layer a bunch of college assignments on top of that, also don't forget the poor time management for the cherry on top. It wasn't good--definitely not doing that again, but hey, the pay was good lol.
...
Ever since I went to college, I stopped doing OSS contributions because I was too busy. I want to get back into it because I really enjoy doing it, I don't want to stop doing it, it was just that--like I mentioned before--I didn't have any time to do anything, really.
...
It's been a long time ago though, I've forgotten already how it feels to contribute into one. It's not going to be easy but I'm gonna have to start somewhere because I love doing open source :)
