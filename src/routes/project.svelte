...
<section class="max-w-[1080px] mx-auto pt-8 px-4 pb-0 text-center">
	...
	<p class="font-sans text-slate-600 dark:text-slate-400 text-lg leading-relaxed mb-4 text-left">
		These are some projects that I do for school assignments, not exactly proud of them since I don't like to make
		these kind of thing. Guess I'd put them here anyway in case anyone needs them for reference or something.
	</p>
