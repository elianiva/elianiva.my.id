...
I've made a remake using NextJS. I didn't choose Svelte because I want to explore more stuff about NextJS and I've done quite a bit of Svelte recently, so doing something different is nice. You can check it out [here](https://elianiva.my.id/project/covid-info-v2)
