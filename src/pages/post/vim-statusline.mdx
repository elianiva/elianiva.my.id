...
I wrote a better version of this in Lua which you can read [here](https://elianiva.my.id/post/neovim-lua-statusline)
...
![old statusline](/assets/post/vim-statusline/old.png)
...
![new statusline](/assets/post/vim-statusline/new.png)
