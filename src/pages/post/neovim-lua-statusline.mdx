...
that is it can now use Lua for its config. Quite a while ago I wrote [this post](https://elianiva.my.id/post/vim-statusline) where I explain how I made my statusline. Now, it's time to update that post using Lua :)
