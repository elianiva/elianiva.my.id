...
![stop](/assets/post/trying-out-sveltekit/stop.webp)
...
![preview](/assets/post/trying-out-sveltekit/preview.webp)
![preview-2](/assets/post/trying-out-sveltekit/preview-2.webp)
...
I managed to deploy this app [here](https://svlt.elianiva.my.id) using `@sveltejs/adapter-vercel`. ~~Though I'm using a temporary fork of mine to make it work~~ It's been fixed. It's *really* satisfying knowing that it finally works!
